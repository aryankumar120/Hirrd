...
export async function getJobs(token, {location, company_id, searchQuery }) {
    ...
    if(error){
        console.error("Cannot fetch any Job", error);
        return null;
    }
    return data;
}
...
export async function saveJob(token, {alreadySaved }, saveData) {
    ...
    if(alreadySaved){
        ...
        if(insertError){
            console.error("Cannot fetch any Job", insertError);
            return null;
        }
    }
...
export async function getSavedJobs(token) {
    ...
    if(error){
        console.error("Error in fetching Saved Job",error);
        return null;
    }
...
export async function deleteJob(token, {job_id}) {
    ...
    if(error){
        console.error("Error in deleting this Job",error);
        return null;
    }
